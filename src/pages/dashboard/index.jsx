...
const Dashboard = () => {
    return (
        <div style={{
            ...
            <WidgetComponent title="Last Activities"
                             children={(
                                 <div style={{
                                     ...
                                     />
                                     <
                                         ActivitiesComponent title={"Software Engineering"}
                                                             percent={45}
                                                             lastHours={32}
                                                             totalCourseHourse={102}
                                     />
            ...
            <WidgetComponent title="Recommend Courses" children={(
                <div style={{
                    display: 'flex',
                    flexDirection: 'row',
                    overflowX: 'auto',
                    ...
                    <RecommendCourses title="Math 201" description="ldsaljkfhasdas adsjklfbhasjkfhddsa hfaskdjflhasjklfhsafhda hdsakfjdashfjksahfdasl hjkadsfhsajkfhsadl fadjkslfhsafls"
                                      alt="image"
